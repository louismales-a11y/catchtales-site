# Fishing Safety Tips — CapCut Production Reference

## Assets Folder
**`\\wsl.localhost\Ubuntu\home\louis\catchtales-site\images\fishing-safety-video\`**
...
01-intro.mp3 through 15-outro.mp3
...
### 1:14 — Slide 8 (12 sec) — Hook Removal (Shallow)
**Image:** first-aid-kit.jpg
**Audio:** "Getting hooked is a matter of when..."
**Text:** "Hook Removal" (green) + "Push point through / Cut barb / Back it out / Clean and apply antiseptic"

### 1:26 — Slide 9 (10 sec) — Deep Hooks & Eyes
**Image:** first-aid-kit.jpg
**Audio:** "If the hook is deep..."
**Text:** "Deep Hooks & Eyes" (cyan) + "Do not remove / Cut line, leave hook / Seek medical attention"

### 1:36 — Slide 10 (12 sec) — Sun Protection
**Image:** sunscreen.jpg
**Audio:** "Water reflects UV rays..."
**Text:** "Sun Protection" (green) + "SPF 30+ broad spectrum / Reapply every 2 hours / UPF 50+ clothing, hat, polarized sunglasses"

### 1:48 — Slide 11 (12 sec) — Cold Water Safety
**Image:** cold-water.jpg
**Audio:** "In water below 15 degrees..."
...
### 2:12 — Slide 13 (10 sec) — Fishing-Specific Risks
**Image:** underwater.webp
**Audio:** "Check behind you before every cast..."
**Text:** "Fishing-Specific Risks" (cyan) + "Check behind before casting / Cover treble hooks / Use pliers / Wash hands after lead"

### 2:22 — Slide 14 (12 sec) — Safety Gear Checklist
**Image:** underwater.webp
**Audio:** "Tape this to your tackle box..."
**Text:** "Safety Gear Checklist" (green) + List: PFD / Whistle / First Aid Kit / Wire Cutters / Sunscreen / UPF Clothing / Polarized Sunglasses / Phone + Waterproof Case / Headlamp / Throw Rope

### 2:34 — Slide 15 (12 sec) — Outro
**Image:** underwater + logo centered
**Audio:** "Stay safe out there..."
**Text:** "catchtales.com" (cyan, 3x large, top center)

---

## CapCut Workflow
1. Import photos from `\fishing-safety-video\`
2. Import audio from `\fishing-safety-video\audio\`
3. Each photo = 1 scene at specified duration
4. Add fade transitions (0.3s)
5. Add text overlays per notes above
6. Export at 1080p, 30fps, MP4
